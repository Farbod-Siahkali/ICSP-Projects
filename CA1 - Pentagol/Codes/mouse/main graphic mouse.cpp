    ...
    while (restart == 1) {
        ...
        while (1) {
            ...
            if (whitewin == 6 || blackwin == 5 || Round == 36)
                break;
            keyboard_move_input(Round, game_table);
            int section_number = rectangle_for_section_mover(Round, game_table);                //getting the section and checking whether it is valid or not
